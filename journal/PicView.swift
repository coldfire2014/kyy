...
class PicView: UIView {
    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        imgLayer = UIView(frame: CGRect(x: 0, y: 0, width: 120.0/2.0, height: 120.0/2.0))
...
//        imgLayer?.addSubview(test)
        ////////////////////////////////
        removeBtn = UIView(frame: CGRect(x: 0, y: 0, width: 26.0/2.0, height: 26.0/2.0))
